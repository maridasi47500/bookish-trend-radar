...
class NewspapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newspaper" do
    assert_difference("Newspaper.count") do
      post newspapers_url, params: { newspaper: { link: @newspaper.link, myinfo: @newspaper.myinfo, name: @newspaper.name } }
    end
  ...
  test "should update newspaper" do
    patch newspaper_url(@newspaper), params: { newspaper: { link: @newspaper.link, myinfo: @newspaper.myinfo, name: @newspaper.name } }
